...
import * as categoriesEffects from './admin-view/store/category/category.effects';
import * as documentEffects from './shared/store/document/document.effects';
import * as authEffects from './auth/store/auth.effects';
import * as userEffects from './admin-view/store/user/user.effects';
...
import * as groupEffects from './admin-view/store/group/group.effects';
...
import { categoryFeatureKey, categoryReducer } from './admin-view/store/category/category.reducers';
import { provideStoreDevtools } from '@ngrx/store-devtools';
import { documentFeatureKey, documentReducer } from './shared/store/document/document.reducers';
...
import { userFeatureKey, userReducer } from './admin-view/store/user/user.reducers';
...
import { groupFeatureKey, groupReducer } from './admin-view/store/group/group.reducers';
