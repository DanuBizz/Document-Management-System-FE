...
describe('CreateDocumentDialogComponentNewDocument', () => {
  let component: DisplayDocumentDialogComponent;
  let fixture: ComponentFixture<DisplayDocumentDialogComponent>;
  let dialogRefSpy: jasmine.SpyObj<MatDialogRef<DisplayDocumentDialogComponent>>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [DisplayDocumentDialogComponent],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DisplayDocumentDialogComponent);
